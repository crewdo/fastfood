 ...
 *
 * @property \App\Model\Table\ProductsCategoriesTable|\Cake\ORM\Association\BelongsTo $ParentProductsCategories
 * @property \App\Model\Table\ProductsCategoriesTable|\Cake\ORM\Association\HasMany $ChildProductsCategories
 *
...
class ProductsCategoriesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('ParentProductsCategories', [
            'className' => 'ProductsCategories',
            'foreignKey' => 'parent_id'
        ]);
        $this->hasMany('ChildProductsCategories', [
            'className' => 'ProductsCategories',
            'foreignKey' => 'parent_id'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['parent_id'], 'ParentProductsCategories'));
