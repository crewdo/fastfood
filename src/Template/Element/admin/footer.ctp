	...
	<footer class="footer">
		...
		<!-- Vendor JS -->
		<script type="text/javascript" src="/admin/vendor/jquery/jquery-1.12.3.min.js"></script>
		<script type="text/javascript" src="/admin/vendor/tether/js/tether.min.js"></script>
		<script type="text/javascript" src="/admin/vendor/bootstrap4/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="/admin/vendor/detectmobilebrowser/detectmobilebrowser.js"></script>
		<script type="text/javascript" src="/admin/vendor/jscrollpane/jquery.mousewheel.js"></script>
		<script type="text/javascript" src="/admin/vendor/jscrollpane/mwheelIntent.js"></script>
		<script type="text/javascript" src="/admin/vendor/jscrollpane/jquery.jscrollpane.min.js"></script>
