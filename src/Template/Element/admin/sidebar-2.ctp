							...
							<div class="notifications">
									...
									<div class="media">
										<div class="media-left">
											<div class="avatar box-48">
												<img class="b-a-radius-circle" src="/admin/img/avatars/1.jpg" alt="">
								...
								<div class="n-item">
									<div class="media">
										<div class="media-left">
											<div class="avatar box-48">
												<img class="b-a-radius-circle" src="/admin/img/avatars/3.jpg" alt="">
								...
								<div class="n-item">
									<div class="media">
										<div class="media-left">
											<div class="avatar box-48">
												<img class="b-a-radius-circle" src="/admin/img/avatars/2.jpg" alt="">
										...
										<div class="media-body">
											...
											<div class="row row-sm my-0-5">
												<div class="col-xs-4">
													<img class="/admin/img-fluid" src="/admin/img/photos-1/1.jpg" alt="">
												</div>
												<div class="col-xs-4">
													<img class="/admin/img-fluid" src="/admin/img/photos-1/2.jpg" alt="">
												</div>
												<div class="col-xs-4">
													<img class="/admin/img-fluid" src="/admin/img/photos-1/3.jpg" alt="">
												</div>
											</div>
								...
								<div class="n-item">
									<div class="media">
										<div class="media-left">
											<div class="avatar box-48">
												<img class="b-a-radius-circle" src="/admin/img/avatars/4.jpg" alt="">
