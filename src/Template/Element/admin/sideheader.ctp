					...
					<div class="navbar-right navbar-toggleable-sm collapse" id="collapse-1">
						...
						<ul class="nav navbar-nav float-md-right">
							<li class="nav-item dropdown">
								<a class="nav-link" href="skins.html#" data-toggle="dropdown" aria-expanded="false">
								...
								<div class="dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
									<div class="t-item">
										<div class="mb-0-5">
											<a class="text-black" href="skins.html#">First Task</a>
										...
										<span class="avatar box-32">
											<img src="/admin/img/avatars/2.jpg" alt="">
										</span>
										<a class="text-black" href="skins.html#">John Doe</a>, <span class="text-muted">5 min ago</span>
									</div>
									<div class="t-item">
										<div class="mb-0-5">
											<a class="text-black" href="skins.html#">Second Task</a>
										...
										<span class="avatar box-32">
											<img src="/admin/img/avatars/3.jpg" alt="">
										</span>
										<a class="text-black" href="skins.html#">John Doe</a>, <span class="text-muted">15:07</span>
									</div>
									<div class="t-item">
										<div class="mb-0-5">
											<a class="text-black" href="skins.html#">Third Task</a>
										...
										<span class="avatar box-32">
											<img src="/admin/img/avatars/4.jpg" alt="">
										</span>
										<a class="text-black" href="skins.html#">John Doe</a>, <span class="text-muted">yesterday</span>
									</div>
									<div class="t-item">
										<div class="mb-0-5">
											<a class="text-black" href="skins.html#">Fourth Task</a>
										...
										<span class="avatar box-32">
											<img src="/admin/img/avatars/5.jpg" alt="">
										</span>
										<a class="text-black" href="skins.html#">John Doe</a>, <span class="text-muted">3 days ago</span>
									</div>
									<a class="dropdown-more" href="skins.html#">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-messages dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
									<div class="m-item">
										...
										<div class="mi-text"><a class="text-black" href="skins.html#">John Doe</a> <span class="text-muted">commented post</span> <a class="text-black" href="skins.html#">Lorem ipsum dolor</a></div>
										<div class="mi-time">5 min ago</div>
									</div>
									<div class="m-item">
										<div class="mi-icon bg-danger"><i class="ti-heart"></i></div>
										<div class="mi-text"><a class="text-black" href="skins.html#">John Doe</a> <span class="text-muted">liked post</span> <a class="text-black" href="skins.html#">Lorem ipsum dolor</a></div>
										<div class="mi-time">15:07</div>
									</div>
									<div class="m-item">
										<div class="mi-icon bg-purple"><i class="ti-user"></i></div>
										<div class="mi-text"><a class="text-black" href="skins.html#">John Doe</a> <span class="text-muted">followed</span> <a class="text-black" href="skins.html#">Kate Doe</a></div>
							...
							<li class="nav-item dropdown hidden-sm-down">
								<a href="skins.html#" data-toggle="dropdown" aria-expanded="false">
									<span class="avatar box-32">
										<img src="/admin/img/avatars/1.jpg" alt="">
									</span>
								</a>
								<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
									<a class="dropdown-item" href="skins.html#">
						...
						<ul class="nav navbar-nav">
							<li class="nav-item hidden-sm-down">
								<a class="nav-link toggle-fullscreen" href="skins.html#">
									...
									<div class="a-grid">
										<div class="row row-sm">
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/dropbox.png" alt=""></div>
											...
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/github.png" alt=""></div>
											...
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/wordpress.png" alt=""></div>
											...
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/gmail.png" alt=""></div>
											...
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/drive.png" alt=""></div>
											...
											<div class="col-xs-4">
												<div class="a-item">
													<a href="skins.html#">
														<div class="ai-icon"><img class="/admin/img-fluid" src="/admin/img/brands/dribbble.png" alt=""></div>
